# Firebase Remote Config 設定値

以下の値をFirebase ConsoleのRemote Configに設定してください。

## キー: `disclaimer_content`
...
```json
{
  ...
  "sections": [
    ...
    },
    {
      ...
      "content": "本規約は、日本法に準拠して解釈されます。本規約に関する紛争については、当方の所在地を管轄する裁判所を第一審の専属的合意管轄裁判所をとします。"
    },
    {
      "title": "11. お問い合わせ",
...
6. 各キーの値として、上記のJSON文字列をそのままコピー&ペースト
7. 「公開」をクリックして反映

**注意**: Firebase Remote Configでは、値の型を「JSON」ではなく「文字列」として設定してください。JSON文字列全体を1つの文字列値として設定します。
