...
class RemoteConfigDefaults {
    ...
    return """
      {
        ...
        "sections": [
          {
            "title": "1. 本アプリについて",
            "content": "本アプリ「LorPalette」は、ディズニーロルカナ（Disney Lorcana）のカード情報を提供する非公式のアプリケーションです。本アプリは、株式会社タカラトミー、ウォルト・ディズニー・カンパニー、またはその関連会社とは一切関係がありません。"
          },
          {
  ...
  private static func getPrivacyPolicyDefault() -> String {
    return """
      {
        "title": "プライバシーポリシー",
        "introduction": "本プライバシーポリシーは、本アプリ「LorPalette」（以下「本アプリ」）における、ユーザーの個人情報の取り扱いについて説明するものです。",
        "sections": [
          {
            "title": "1. 収集する情報",
  ...
  private static func getTermsOfServiceDefault() -> String {
    return """
      {
        "title": "利用規約",
        "introduction": "本利用規約（以下「本規約」）は、本アプリ「LorPalette」（以下「本アプリ」）の利用条件を定めるものです。本アプリを利用することにより、ユーザーは本規約に同意したものとみなされます。",
        "sections": [
          {
            "title": "1. 規約の適用",
